...
class ResConfigSettings(models.TransientModel):
    ...
    module_account_invoice_comment_template = fields.Boolean(string='account_invoice_comment_template',
    ...
    module_base_comment_template = fields.Boolean(string='base_comment_template',
